...
cp ~/.bash_history ~/UTN-FRA_SO_Examenes/RTA_Examen_20250704/
ll
ls -l ~/UTN-FRA_SO_Examenes/RTA_Examen_20250704/.bash_history
cd RTA_Examen_20250704/
ll
cd ..
mv ~/.bash_history ~/UTN-FRA_SO_Examenes/
mv ~/UTN-FRA_SO_Examenes/RTA_Examen_20250704/.bash_history ~/UTN-FRA_SO_Examenes/
ls -l ~/UTN-FRA_SO_Examenes/.bash_history
cd 202406/
ll
cd ..
ll
git clone https://github.com/shianmm/UTNFRA_SO_2do_TP_Yovera.git
ll
cd UTNFRA_SO_2do_TP_Yovera/
cp -p /UTN_FRA_SO_Examenes/ ./202406
cp -r ~/UTN-FRA_SO_Examenes ./202406
ll
cp -r ~/UTN-FRA_SO_Examenes ./RTA_Examen_20250704
ll
cp -r ~/UTN-FRA_SO_Examenes /.bash_history
historial -a
history -a
